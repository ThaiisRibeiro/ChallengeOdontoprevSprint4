...
namespace ChallengeOdontoprevSprint3.Migrations
{
    ...
    [Migration("20250502194542_AlterPacienteAdicionarCepNullable")]
    partial class AlterPacienteAdicionarCepNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChallengeOdontoprevSprint3.Model.Agendamento", b =>
                {
                    ...
                    b.ToTable("Api_Dotnet_Agendamentos");
                });

            modelBuilder.Entity("ChallengeOdontoprevSprint3.Model.Clinica", b =>
                {
                    b.Property<int>("id_clinica")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)");
                    ...
                    b.ToTable("Api_Dotnet_Clinicas");
                });

            modelBuilder.Entity("ChallengeOdontoprevSprint3.Model.ContasPagar", b =>
                {
                    ...
                    b.ToTable("Api_Dotnet_Contas_Pagar");
                });

            modelBuilder.Entity("ChallengeOdontoprevSprint3.Model.ContasReceber", b =>
                {
                    ...
                    b.ToTable("Api_Dotnet_Contas_Receber");
                });

            modelBuilder.Entity("ChallengeOdontoprevSprint3.Model.Dentista", b =>
                {
                    b.Property<int>("id_dentista")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)");
                    ...
                    b.ToTable("Api_Dotnet_Dentistas");
                });

            modelBuilder.Entity("ChallengeOdontoprevSprint3.Model.Fraude", b =>
                {
                    ...
                    b.ToTable("Api_Dotnet_Fraudes");
                });

            modelBuilder.Entity("ChallengeOdontoprevSprint3.Model.Paciente", b =>
                {
                    b.Property<int>("id_paciente")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)");
                    ...
                    b.ToTable("Api_Dotnet_Pacientes");
                });

            modelBuilder.Entity("ChallengeOdontoprevSprint3.Model.TabelaPreco", b =>
                {
                    b.Property<int>("id_tabela_preco")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)");
                    ...
                    b.ToTable("Api_Dotnet_Tabela_Precos");
                });
